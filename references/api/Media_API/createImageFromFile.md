---
title: createImageFromFile
category: Media_API
api_name: createImageFromFile
method: POST
path: /image/create_image_from_file
---

**Category:** Media_API
**API:** createImageFromFile

**Method:** POST
**HTTP Path:** https://apim.ebay.com{basePath}/image/create_image_from_file
