...
**Method:** GET
**HTTP Path:** https://api.ebay.com{basePath}/shipment/{shipmentId}
...
| --- | --- | --- | --- |
| shipmentId (path) | string | Yes | This path parameter specifies the unique eBay-assigned identifier of the shipment you want to retrieve. The shipmentId value is generated and returned by the createFromShippingQuote method. |
