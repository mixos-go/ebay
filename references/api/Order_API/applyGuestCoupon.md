---
title: applyGuestCoupon
category: Order_API
api_name: applyGuestCoupon
method: POST
path: /guest_checkout_session/{checkoutSessionId}/apply_coupon
---

**Category:** Order_API
**API:** applyGuestCoupon

**Method:** POST
**HTTP Path:** https://apix.ebay.com{basePath}/guest_checkout_session/{checkoutSessionId}/apply_coupon
