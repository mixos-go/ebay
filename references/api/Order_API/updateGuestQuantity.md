---
title: updateGuestQuantity
category: Order_API
api_name: updateGuestQuantity
method: POST
path: /guest_checkout_session/{checkoutSessionId}/update_quantity
---

**Category:** Order_API
**API:** updateGuestQuantity

**Method:** POST
**HTTP Path:** https://apix.ebay.com{basePath}/guest_checkout_session/{checkoutSessionId}/update_quantity
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| lineItemId | string | No | A unique eBay-assigned ID value that identifies a line item in a purchase order. For example: v1\|2**********6\|5**********4 or v1\|1**********9\|0 . For more information about item IDs for RESTful APIs, see Legacy API compatibility . |
| quantity | integer | No | The quantity of the line item that you wish to update. |
