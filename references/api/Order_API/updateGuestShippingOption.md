---
title: updateGuestShippingOption
category: Order_API
api_name: updateGuestShippingOption
method: POST
path: /guest_checkout_session/{checkoutSessionId}/update_shipping_option
---

**Category:** Order_API
**API:** updateGuestShippingOption

**Method:** POST
**HTTP Path:** https://apix.ebay.com{basePath}/guest_checkout_session/{checkoutSessionId}/update_shipping_option
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| lineItemId | string | No | A unique eBay-assigned ID value that identifies the line item in a checkout session. For example: v1\|2**********6\|5**********4 or v1\|1**********9\|0 . For more information about item IDs for RESTful APIs, see Legacy API compatibility |
| shippingOptionId | string | No | A unique identifier of the selected shipping option/method. |
