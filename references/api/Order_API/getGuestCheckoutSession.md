---
title: getGuestCheckoutSession
category: Order_API
api_name: getGuestCheckoutSession
method: GET
path: /guest_checkout_session/{checkoutSessionId}
---

**Category:** Order_API
**API:** getGuestCheckoutSession

**Method:** GET
**HTTP Path:** https://apix.ebay.com{basePath}/guest_checkout_session/{checkoutSessionId}
