---
title: removeGuestCoupon
category: Order_API
api_name: removeGuestCoupon
method: POST
path: /guest_checkout_session/{checkoutSessionId}/remove_coupon
---

**Category:** Order_API
**API:** removeGuestCoupon

**Method:** POST
**HTTP Path:** https://apix.ebay.com{basePath}/guest_checkout_session/{checkoutSessionId}/remove_coupon
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| redemptionCode | string | No | The redemption code of the coupon. Maximum: One redemption code per order |
