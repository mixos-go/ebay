---
title: getReturnPolicyByName
category: Account_v1_API
api_name: getReturnPolicyByName
method: GET
path: /return_policy/get_by_policy_name
---

**Category:** Account_v1_API
**API:** getReturnPolicyByName

**Method:** GET
**HTTP Path:** https://api.ebay.com{basePath}/return_policy/get_by_policy_name
...
| marketplace_id (query) | string | Yes | This query parameter specifies the ID of the eBay marketplace of the policy you want to retrieve. For implementation help, refer to eBay API documentation at https://developer.ebay.com/api-docs/sell/account/types/ba:MarketplaceIdEnum |
| name (query) | string | Yes | This query parameter specifies the seller-defined name of the return policy you want to retrieve. This value can be retrieved for a return policy by using the getReturnPolicies method. |
